    ...
    <div className="w-full ">
      <div className="flex flex-col justify-center text-justify items-center mx-2 gap-2 mt-2">
        ...
        <p className="text-xs text-center">
          Get deep insights into any coder's performance with our platform.{" "}
        </p>

        <p className="hidden">
          Discover their coding strengths and weaknesses, check their progress
          over time, and compare their skills to others. Leverage the power of
          data to enhance your coding journey.
        </p>
        ...
        <div className="flex gap-2">
          ...
          />
          <button type="button" className="border-2 p-1" text="Search">
            <MagnifyingGlassIcon
